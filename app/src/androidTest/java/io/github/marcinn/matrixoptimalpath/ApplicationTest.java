...
public class ApplicationTest {
    ...
    public void testIfRecyclerViewIsFilledProperly() throws Exception {
        ...
        onView((withId(R.id.recyclerView_table))).perform(scrollToHolder(new TableViewHolderMatcher()).atPosition(0));
        onView(withText(c0.toString())).check(matches(isDisplayed()));
        onView((withId(R.id.recyclerView_table))).perform(scrollToHolder(new TableViewHolderMatcher()).atPosition(1));
        onView(withText(c1.toString())).check(matches(isDisplayed()));
        onView((withId(R.id.recyclerView_table))).perform(scrollToHolder(new TableViewHolderMatcher()).atPosition(2));
        onView(withText(c2.toString())).check(matches(isDisplayed()));
        onView((withId(R.id.recyclerView_table))).perform(scrollToHolder(new TableViewHolderMatcher()).atPosition(3));
        onView(withText(c3.toString())).check(matches(isDisplayed()));
        onView((withId(R.id.recyclerView_table))).perform(scrollToHolder(new TableViewHolderMatcher()).atPosition(4));
    ...
    public void testWithAddTextButton() throws Exception {
        ...
        WordCell c0 = new WordCell("pieniądze", 528);
        onView(withItemText(c0.toString())).check(doesNotExist());
        onView((withId(R.id.recyclerView_table))).perform(scrollToPosition(2608));
